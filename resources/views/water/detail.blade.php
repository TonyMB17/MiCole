...
@section('jsSection')
    ...
    <script>
        const labels = @json($chartLabels); // Etiquetas de los meses
        const data = {
            labels: labels,
            datasets: [{
                    label: 'Semana 1',
            ...
            options: {
                ...
                scales: {
                    x: {
                        ...
                        grid: {
                            color: 'rgba(0, 0, 0, 0.4)' // Cambia el color de las líneas de la cuadrícula vertical
                        }
                    },
                    y: {
                        beginAtZero: true,
                        max: 1, // Establecer el máximo del eje Y a 1
                        ticks: {
                            stepSize: 0.1, // Opcional: Incrementos de 0.1 entre valores
                        }
                    }
                }
            }
